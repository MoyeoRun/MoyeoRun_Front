...
const FriendIcon = ({ color, ...props }: { color: string }) => {
  const source = `
  <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle cx="17.7231" cy="5.83198" r="2.13832" stroke="${color}" stroke-width="1.5"/>
  ...
  <path d="M9.18514 9.54999C4.45274 9.54999 2.14288 12.0007 2.14288 13.5007V18.0007H9.18514" stroke="${color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9.14287 9.54999C13.8753 9.54999 16.1851 12.0007 16.1851 13.5007V18.0007H9.14287" stroke="${color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <circle cx="9.18512" cy="3.94366" r="3.19366" stroke="${color}" stroke-width="1.5"/>
  </svg>
  `;
